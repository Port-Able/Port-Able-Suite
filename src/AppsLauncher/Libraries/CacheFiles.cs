namespace AppsLauncher.Libraries
{
    ...
    public static class CacheFiles
    {
        ...
        /// </summary>
        public static string AppSettingsDir { get; } = Path.Combine(CorePaths.DataDir, "AppSettings");
        ...
        ///     ***WIP
        /// </summary>
        internal static string SettingsMerges { get; } = Path.Combine(CorePaths.DataDir, "SettingsMerges.dat");
    }
}
