namespace Updater.Libraries
{
    ...
    internal static class CorePaths
    {
        ...
        internal static string AppsLauncher =>
            _appsLauncher ?? (_appsLauncher = Path.Combine(PathEx.LocalDir, "AppsLauncher.exe"));
        ...
        internal static string RepoCommitsUrl =>
            _repoCommitsUrl ?? (_repoCommitsUrl = PathEx.AltCombine(RepoProfileUrl, "Port-Able-Suite/commits/master.atom"));

        internal static string RepoReleasesUrl =>
            _repoReleasesUrl ?? (_repoReleasesUrl = PathEx.AltCombine(RepoProfileUrl, "Port-Able-Suite/releases"));

        internal static string RepoSnapshotsUrl =>
            _repoSnapshotsUrl ?? (_repoSnapshotsUrl = PathEx.AltCombine(RepoProfileUrl, "Port-Able-Suite-Snapper/raw/master"));
